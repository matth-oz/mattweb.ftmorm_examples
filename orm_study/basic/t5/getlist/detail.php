<?php 
    /*
	→ в каких матчах участвовал за период
	→ сколько голов забил за период
	→ сколько получил взысканий за период
    */
    ...
    if(!empty($reqValues['pl_id'])){
        ...
        $arPlayer = Ftmorm\PlayersTable::getById($plID)->fetch();
        ...
        $gamesRes = Ftmorm\LineupsTable::getList([
            'select' => ['GOAL_SUMM', 'CARDS', 'GM_'=>'GAME', 'TM_NAME'=>'GAME.TEAM.NAME'],
            'group' => ['GM_ID'],
            'filter' => ['PLAYER_ID'=>$plID],
...
<head>
    ...
    <body>
        <div class="main-wrap">
            ...
            <div class="foot">
                <p><a href="/test_orm/basic/t5/getlist/">← К списку</a></p>
            </div>
        </div>
    </body>
</html>
