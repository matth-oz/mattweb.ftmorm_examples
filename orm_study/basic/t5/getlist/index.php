<?php 
    ...
    'select' => ['LAST_GAME_DATE', 'FIRST_GAME_DATE'],
        'runtime' =>[
            new Entity\ExpressionField('LAST_GAME_DATE', 'MAX(%s)', ['GAME_DATE']),
            new Entity\ExpressionField('FIRST_GAME_DATE', 'MIN(%s)', ['GAME_DATE']),
        ],
    ]);
    ...
    $playersRes = Ftmorm\PlayersTable::getList([
        'select' => ['ID', 'FIRST_NAME', 'LAST_NAME', 'NICKNAME', 'CITIZENSHIP', 'DOB', 'ROLE'],
    ]);
...
<div class="main-wrap">
        ...
        <div class="main-cont">
            <table class="main-tbl">
                ...
                <tr>
                    <td>
                    <a href="/test_orm/t5/getlist/detail.php?pl_id=<?=$arPlayer['PLAYER_ID']?>"><?=$arPlayer['PLAYER_FN'].' '.$arPlayer['PLAYER_LN']?></a>
                    </td>
                    <td>
                    <a href="/test_orm/t5/getlist/detail.php?pl_id=<?=$arPlayer['PLAYER_ID']?>"><?=$arPlayer['PLAYER_NN']?></a>
                    </td>
                    <td>
                    <a href="/test_orm/t5/getlist/detail.php?pl_id=<?=$arPlayer['PLAYER_ID']?>"><?=$arPlayer['PLAYER_DOB']?></a>
                    </td>
                    <td>
                    <a href="/test_orm/t5/getlist/detail.php?pl_id=<?=$arPlayer['PLAYER_ID']?>"><?=$arPlayer['PLAYER_CITIZEN']?></a>
                    </td>
                    <td>
                    <a href="/test_orm/t5/getlist/detail.php?pl_id=<?=$arPlayer['PLAYER_ID']?>"><?=$arPlayer['PLAYER_ROLE']?></a>
                    </td>
                </tr>
                <?endforeach?>
            </table>
