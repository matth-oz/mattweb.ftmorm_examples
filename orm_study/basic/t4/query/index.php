    ...
    <div class="main-wrap">
        ...
        <div class="main-cont">
            ...
            <table class="main-tbl">
                ...
                <td>
                    <a href="/test_orm/t4/query/detail.php?gm_id=<?=$arMatch['ID']?>"><?=$arMatch['ORD_NUMBER']?></a>
                    </td>
                    <td>
                    <a href="/test_orm/t4/query/detail.php?gm_id=<?=$arMatch['ID']?>"><?=$arMatch['GAME_DATE']?></a>
                    </td>
                    <td>
                    <a href="/test_orm/t4/query/detail.php?gm_id=<?=$arMatch['ID']?>"><?=$arMatch['CITY']?></a>
                    </td>
                    <td>
                    <a href="/test_orm/t4/query/detail.php?gm_id=<?=$arMatch['ID']?>"><?=$arMatch['TM_NAME']?></a>
                    </td>
                    <td>
                    <a href="/test_orm/t4/query/detail.php?gm_id=<?=$arMatch['ID']?>"><?=$arMatch['GAME_SCORE']?></a>
                    </td>
                    <td <?if($arMatch['AUTO_GOALS'] > 0):?>class="ag-alert"<?endif?>>
                    <a href="/test_orm/t4/query/detail.php?gm_id=<?=$arMatch['ID']?>"><?=$arMatch['AUTO_GOALS']?></a>
                    </td>
                </tr>
                <?endforeach?>
            </table>
